 ...
 * outside of the DeleteDeveloperCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the DeleteDeveloperCommand, and therefore we test only one of them.
...
public class DeleteDeveloperCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new DeleteDeveloperCommand(INDEX_FIRST_PERSON));
    }
