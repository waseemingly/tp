...
public class ProjectClientContainsKeywordsPredicate implements KeywordPredicate<Client> {
    ...
    public boolean test(Client client) {
        return keywords.stream()
                .anyMatch(keyword -> StringUtil.containsWordIgnoreCase(client.getProjects().toString(), keyword));
    }
    ...
    public boolean equals(Object other) {
        ...
        seedu.address.model.client.ProjectClientContainsKeywordsPredicate otherPredicate = (seedu.address.model.client.ProjectClientContainsKeywordsPredicate) other;
